...
import { RecommendationCard, AfternoonRecommendationCard } from '../components/recommendation';
...
const HomePage: React.FC = () => {
  ...
  useEffect(() => {
    document.title = '每日选股分析 - All In Success';
  }, []);
    ...
    >
      <div className="flex-1 flex flex-col min-h-0 min-w-0 max-w-full lg:max-w-6xl mx-auto w-full">
        ...
        <div className="flex-1 flex min-h-0 overflow-hidden">
          ...
          {/* 右侧 - 新手股票推荐 + 尾盘推荐 */}
          <aside className="hidden min-h-0 w-64 shrink-0 flex-col pr-4 pb-4 lg:flex lg:w-72">
